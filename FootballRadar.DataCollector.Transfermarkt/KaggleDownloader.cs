...
{
    public static class KaggleDownloader
    {
        ...
        public static List<TransferRecord> DownloadAndImport(string datasetSlug, string csvFileName, string outputPath, string apiToken)
        {
